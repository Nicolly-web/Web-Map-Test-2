...
map.getView().fit([-8768767.607997, -4178765.090341, 4128638.049360, 654000.538618], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MAPA WEB TEST</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (28 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Resumo teste para o mapa web';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_LimiteUCsFederais_26122023_a_1,
    colName: 'BiomaIBGE',
    zoom: 10,
    collapsed: true,
    map: map
